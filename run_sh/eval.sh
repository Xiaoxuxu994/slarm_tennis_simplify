...
# ---- LSeg + ball token（本仓主线实验）----
# config 必须与 ckpt 配对：misc.load_model 是 strict=False 且对 missing/unexpected
# keys 只 pass，用不带 use_ball_token 的 config 评带 ball token 的 ckpt 会静默丢弃
# ball_query/ball_block/ball_head；反过来则是随机初始化，两个方向都不报错。
...
# CONFIG="configs/exp0818_003_slarm_stream25_24cm_triview_window6_uplr_re2.yaml"
# CKPT="work_dirs/slarm/exp0818_003_slarm_stream25_24cm_triview_window6_uplr_re2/checkpoints/ckpt_039999.pth"
